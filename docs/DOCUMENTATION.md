...
- `config/opencode-modern.json` - OpenCode v1.0.210+ variant-based template (15 bases / 70 variants)
- `config/opencode-legacy.json` - OpenCode v1.0.209 and below template (70 explicit entries)
